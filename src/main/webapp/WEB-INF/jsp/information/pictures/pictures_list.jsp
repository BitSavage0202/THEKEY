...
<body class="no-skin">
				...
				<table style="width:100%;">
					<tr>
						<td style="vertical-align:top;">
							<ts:rights code="pictures/goAdd">
								<a class="btn btn-sm btn-success" onclick="add();">新增</a>
							</ts:rights>
							<ts:rights code="pictures/deleteAll">
	...
	<script type="text/javascript">
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=path%>/pictures/goAdd.do';
			 diag.Width = 800;
			 diag.Height = 490;
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=path%>/pictures/goEdit.do?PICTURES_ID='+Id;
			 diag.Width = 600;
			 diag.Height = 465;
			 diag.CancelEvent = function(){ //关闭事件
