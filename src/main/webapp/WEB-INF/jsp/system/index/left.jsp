<div id="sidebar" class="sidebar                  responsive">
				...
				<div class="sidebar-shortcuts" id="sidebar-shortcuts">
					<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
						...
						<button class="btn btn-success" title="预留功能" >
							<i class="ace-icon fa fa-signal"></i>
						</button>

						<!-- #section:basics/sidebar.layout.shortcuts -->
						<button class="btn btn-warning" title="预留功能" id="adminzidian">
							<i class="ace-icon fa fa-book"></i>
						</button>

						<button class="btn btn-danger" title="预留功能" >
				...
				<c:if test="${menu1.hasMenu && 1 == menu1.MENU_STATUS}">
					<li class=""  id="lm${menu1.MENU_ID }">
						...
						<c:forEach items="${menu1.subMenu}" var="menu2">
							<c:if test="${menu2.hasMenu && 1 == menu2.MENU_STATUS}">
							<li class="" id="z${menu2.MENU_ID }">
								...
								<ul class="submenu">
									...
									<c:if test="${menu3.hasMenu && 1 == menu3.MENU_STATUS}">
										<li class="" id="m${menu3.MENU_ID }">
											...
											<ul class="submenu">
												...
												<c:if test="${menu4.hasMenu && 1 == menu4.MENU_STATUS}">
