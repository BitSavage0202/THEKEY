			...
			<form action="" method="post" name="loginForm"
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="text" name="loginname" id="loginname" value="" placeholder="请输入用户名" maxlength="32"/>
						</div>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="password" name="password" id="password" value="" placeholder="请输入密码" class="keypad" keypadMode="full" allowKeyboard="true" value="" maxlength="32"/>
						</div>
					</div>
				</div>
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<div style="float: left;">
							<i><img style="height:26px;" id="codeImg" alt="点击更换"
								title="点击更换" src="" /></i>
						</div>
				...
				$.ajax({
					...
					success: function(data){
						if("success" == data.result){
							...
							showfh();
							$("#code").focus();
						}else if("userFreeze" == data.result){
							$("#loginname").tips({
								side : 1,
								msg : "用户已经被冻结",
								bg : '#FF5080',
